...
function transArrToNumArr(arr) {
    return arr.map(function (t) { return t.valueOf(); });
}
exports.transArrToNumArr = transArrToNumArr;
var Rock = (function () {
    function Rock() {
        this.timeSpan = 1;
    ...
    Rock.prototype.calcDelta = function () {
        this.delta = utils_functions_1.ArraySum(transArrToNumArr(this._credits)) - utils_functions_1.ArraySum(transArrToNumArr(this._debits));
    };
    return Rock;
}());
exports.Rock = Rock;
